...
export default defineEventHandler((): AboutData => {
  return {
    title: "About Us",
    description:
      "We are a leading company in technology and innovation, striving to provide advanced solutions that meet our clients' needs and contribute to their success. Since our establishment in 2010, we have worked on building long-term relationships with our clients through high-quality services and innovative solutions. Our specialized team includes more than 150 experts in various technical and creative fields.",
