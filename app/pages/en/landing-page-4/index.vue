...
import Services from "~/components/ar/landing-page-4/services.vue";
...
const { data: homeData } = await useFetch<HomeResponse>("/api/home/en");
...
<template>
  <div class="bg-white w-full min-h-screen" dir="ltr">
    ...
    <Services :data="homeData as HomeResponse" :direction="'ltr'" />
