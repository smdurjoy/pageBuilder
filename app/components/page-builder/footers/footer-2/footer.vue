...
<template>
  <footer
    ...
    :dir="props.dir"
  >
    <div class="pb-f2-wrapper">
      <div class="pb-f1-grid">
        <!-- Company Column -->
        <div class="pb-f1-col pb-f1-col-company">
          <h2 class="pb-f2-company-name">{{ footerData.company.name }}</h2>
          <p class="pb-f1-company-desc">{{ footerData.company.description }}</p>
        </div>

        <!-- Quick Links Column -->
        <div class="pb-f1-col">
          <h3 class="pb-f2-col-title">{{ footerData.quickLinks.title }}</h3>
          <ul class="pb-f2-links-list">
            <li v-for="(link, idx) in footerData.quickLinks.links" :key="idx">
              <a :href="link.href" class="pb-f2-link">{{ link.label }}</a>
            </li>
          </ul>
        </div>
        ...
        <!-- Contact Column -->
        <div class="pb-f1-col">
          <h3 class="pb-f2-col-title">{{ footerData.contact.title }}</h3>
        ...
        <!-- Social Column -->
        <div class="pb-f1-col">
          <h3 class="pb-f2-col-title">{{ footerData.social.title }}</h3>
