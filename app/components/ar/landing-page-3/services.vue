...
import type { ServicesType } from "~/types/landing-page-3";
...
<template>
  <section class="container mx-auto px-4 sm:px-6 mt-20">
    <h2
      class="text-navy text-3xl lg:text-4xl font-bold text-center sm:text-start"
    >
      {{ data?.title }}
    </h2>
    <p
      class="text-navy text-lg lg:text-2xl text-center sm:text-start mt-4"
    >
      {{ data?.description }}
    </p>
