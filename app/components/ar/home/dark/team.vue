  ...
  <section class="mt-20 px-4 sm:px-6">
    ...
    <div class="mt-10 container mx-auto">
      ...
      >
        <CarouselContent>
          <CarouselItem
            v-for="(member, idx) in data?.team.items"
            :key="member.title"
            class="basis-full sm:basis-1/2 xl:basis-1/3 pl-6 md:pl-8"
          >
            <Card
              class="py-8 sm:py-12 md:py-16 px-6 sm:px-8 flex flex-col gap-8"
            ...
            >
              ...
              <div class="space-y-3">
                ...
                <p
                  class="text-cream w-full lg:w-[80%] font-semibold text-base lg:text-xl"
                >
                  {{ member.description }}
                </p>
              </div>
