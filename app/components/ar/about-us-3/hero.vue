...
<template>
  <section class="mt-20 w-full">
    <div
      class="container mx-auto w-full grid grid-cols-1 lg:grid-cols-2 items-center"
    >
      ...
      <div
        :class="[
          'w-[80%] flex justify-center mx-auto lg:mx-0',
          isLTR ? 'lg:order-1' : '',
        ]"
      >
        <div
      ...
      >
        <div
          class="relative w-full h-80 md:h-[70vh] rounded-[39px] overflow-hidden"
        >
          <img
            :src="data.hero.heroImage3"
            alt="hero"
