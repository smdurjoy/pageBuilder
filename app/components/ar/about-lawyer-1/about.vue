...
<template>
  ...
  <div class="mt-10 px-4 sm:px-6 space-y-6">
    <Card
      :class="`py-8 sm:py-12 md:py-16 px-6 sm:px-8 flex flex-col items-center text-center gap-8 bg-cream! border-cream! hover:bg-cream! transition-colors duration-300`"
